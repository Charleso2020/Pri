...
const MeanofNumbers = (firstNum, secondNum) => {
  const mean = (firstNum + secondNum)/2;
  return  mean;
}
...
async function handle_advance(data) {
  ...
  const result = MeanofNumbers(firstNumber, secondNumber);
...
async function handle_inspect(data) {
  ...
  const responseObject = "Inspect route not implemented for mean of two numbers";
